...
<header id="header_main">
	...
	<div class="nav">
		<ul class="nav-list">
			...
			<li class="nav-list-item"><a href="<?=$_SERVER['PHP_SELF']?>">Sign-up</a></li>
		</ul>
	</div>
</header>

<div class='content'>
	<h2 class='header'>Sign up your new account</h2>
	<div class="container">
		<p><strong>Main information :</strong></p>
		<form method="POST" action="<?=$_SERVER['PHP_SELF']?>" class='form' id="signup_form">
			...
			<div class="row form-control">
				...
				<div class="col-75">
					<input type="text" id="retype_password" name="retype_password" placeholder="Please retype your password..">
				</div>
			</div>
			...
			<div class="row form-control">
				...
				<div class="col-75">
					<input type="file" id="picture" name="profile_picture">
				</div>
			</div>
			...
			<div class="row form-control">
				<div class="col-25">
					<label for="zip_code">Zipcode (4 to 6 digits) :</label>
				</div>
				<div class="col-75">
					<input type="text" id="zip_code" name="zip_code" placeholder="Your zipcode..">
				</div>
			</div>
			...
			<div class="row form-control">
				<div class="col-25">
					<label for="zip_code">Type of User :</label>
				</div>
				<div class="col-75">
					<div class='radio'>
						<input type="radio" id="store_owner" name="user_type" value="male">
						<label>Store Owner</label><br>
					</div>
					<div>
						<input type="radio" id="shopper" name="user_type" value="female">
						<label>Shopper</label><br>
					</div>
				</div>
			</div>
			...
			<div class="store_owner_section">
				<p><strong>Fill this part if you are registering as a store owner :</strong></p>
				<div class="row form-control">
					<div class="col-25">
						<label for="counstry">Business Name :</label>
					</div>
					<div class="col-75">
						<input type="text" id="b_name" name="business_name" placeholder="Your zipcode..">
					</div>
				</div>
				<div class="row form-control">
					<div class="col-25">
					...
					<div class="col-75">
						<input type="text" id="s_name" name="store_name" placeholder="Your zipcode..">
					</div>
				</div>
				<div class="row form-control">
					<div class="col-25">
					...
					<div class="col-75">
						<select id='store_category' name='store_category'>
							...
							<option value="accessory_store">Accessory Store</option>
							<option value="pharmacy">Pharmacy</option>
							<option value="technology_store">Technology Store</option>
							<option value="pet_store">Pet Store</option>
							<option value="toy_store">Toy Store</option>
							<option value="specialty_store">Specialty Store</option>
...
<div id="cookie">
	<div class="cookie-container">
		<p>My website uses cookies necessary for its basic functioning. By continuing browsing, you consent to my use of
...
<!--//footer-->
<!--<script type="text/javascript" src="../js/hien_nguyen_signup_validation.js"></script>-->

<script type="text/javascript" src="../js/hien_nguyen_validation.js"></script>
<script>
